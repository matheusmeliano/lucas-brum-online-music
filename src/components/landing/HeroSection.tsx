...
export default function HeroSection() {
  ...
  return (
    <section id="topo" className="relative -mt-[50px] overflow-hidden bg-[#050505]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-12 pt-[112px] sm:pb-16 sm:pt-[132px]">
        <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[linear-gradient(135deg,rgba(20,14,10,0.96)_0%,rgba(11,9,8,0.98)_48%,rgba(12,9,7,0.96)_100%)] shadow-[0_30px_120px_rgba(0,0,0,0.55)]">
          <div className="pointer-events-none absolute inset-0">
            ...
            <div className="absolute inset-y-0 left-[46%] hidden w-px bg-[linear-gradient(to_bottom,transparent,rgba(255,255,255,0.12),transparent)] lg:block" />
          </div>

          <div className="relative grid gap-12 px-5 py-8 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(360px,0.98fr)] lg:gap-8 lg:px-10 lg:py-12 xl:px-12">
            <Reveal immediate className="relative z-10 flex flex-col justify-center">
              ...
              <h1 className="mt-6 max-w-[11ch] text-balance font-serif text-[2.8rem] leading-[0.96] tracking-[-0.04em] text-white sm:text-[3.6rem] lg:text-[4.4rem]">
                Aprenda violão ao vivo, com as músicas que você ama.
              </h1>

              <p className="mt-5 max-w-xl text-pretty text-[15px] leading-7 text-white/72 sm:text-[17px]">
            ...
            <Reveal immediate className="relative z-10 flex items-center justify-center lg:justify-end">
              <div className="relative w-full max-w-[520px]">
                <div className="absolute inset-x-[8%] top-[10%] h-[72%] rounded-full bg-brand-glow/30 blur-3xl" />
                <div className="absolute left-1/2 top-1/2 h-[88%] w-[88%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-brand-glow/12" />
                <div className="absolute left-1/2 top-1/2 h-[72%] w-[72%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-brand-glow/10" />
                <div className="absolute inset-x-[4%] bottom-[7%] h-24 rounded-full bg-black/65 blur-2xl" />

                <motion.img
                  src="/imagens/simbolo-musica-02.png"
                  alt=""
                  className="pointer-events-none absolute -left-1 top-[18%] h-9 w-9 opacity-60 [filter:brightness(0)_saturate(100%)_invert(70%)_sepia(62%)_saturate(701%)_hue-rotate(340deg)_brightness(101%)_contrast(102%)] sm:h-11 sm:w-11"
                ...
                <motion.img
                  ...
                  alt=""
                  className="pointer-events-none absolute right-0 top-[12%] h-10 w-10 opacity-55 [filter:brightness(0)_saturate(100%)_invert(70%)_sepia(62%)_saturate(701%)_hue-rotate(340deg)_brightness(101%)_contrast(102%)] sm:h-12 sm:w-12"
                ...
                <motion.img
                  src="/imagens/simbolo-musica-02.png"
                  alt=""
                  className="pointer-events-none absolute right-[6%] top-[64%] h-8 w-8 opacity-45 [filter:brightness(0)_saturate(100%)_invert(70%)_sepia(62%)_saturate(701%)_hue-rotate(340deg)_brightness(101%)_contrast(102%)] sm:h-10 sm:w-10"
                ...
                <motion.img
                  ...
                  className="relative z-10 ml-auto w-full max-w-[520px] object-contain brightness-[1.04] contrast-[1.02] saturate-0 sepia-[0.16] drop-shadow-[0_30px_45px_rgba(0,0,0,0.6)]"
                  loading="eager"
                />
              </div>
            </Reveal>
          ...
          <div className="relative z-10 flex flex-col gap-4 border-t border-white/10 px-5 py-4 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10 xl:px-12">
