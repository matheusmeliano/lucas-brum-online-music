...
function AboutSection() {
  ...
  return (
    <section id="como-funciona" className="relative bg-[#000000] scroll-mt-[120px]">
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-0 sm:pb-20 sm:pt-0">
        <Reveal>
          <div className="grid gap-10">
            <div className="w-full">
              <div className="overflow-hidden rounded-[28px] border border-brand-border bg-white/4 backdrop-blur-md">
